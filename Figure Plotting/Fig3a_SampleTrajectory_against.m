...
sourcename = '141111_fc2_x2y2_SDy_results.txt';
...
cd(dest)
print(fullfile(dest,strcat('Fig3a', '_trajectory_',namebase)), '-dpng', '-r300')
...
fullname = fullfile(dest, strcat('Fig3a_SourceData_', namebase,'.txt'));
